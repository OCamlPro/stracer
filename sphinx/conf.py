...
# -*- coding: utf-8 -*-
#
# stracer documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'stracer.tex', 'stracer Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'stracer', 'stracer Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'stracer', 'stracer Documentation',
     author, 'stracer', 'One line description of project.',
     'Miscellaneous'),
]
